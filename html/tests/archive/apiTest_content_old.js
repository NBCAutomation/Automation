    ...
    var apiSuite = function(url) {
        ...
        *******************/
        casper.start( url ).then(function(response) {
            ...
            collectionObject['breaking__modules'] = 'http://www.' + urlUri + '.com/apps/news-app/breaking/modules/?apiVersion=' + apiVersion + enableJsonValidation;
            collectionObject['just-in__live'] = 'http://www.' + urlUri + '.com/apps/news-app/just-in/live/?apiVersion=' + apiVersion + enableJsonValidation;
            collectionObject['school_closings__alerts'] = 'http://www.' + urlUri + '.com/apps/news-app/alerts?apiVersion=' + apiVersion + enableJsonValidation;
