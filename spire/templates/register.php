								...
								<div class="col-md-6 col-md-offset-3">
									<div class="well row pt-2x pb-3x bk-light">
										<div class="col-md-8 col-md-offset-2">
											...
											<form action="/register/main" method="post" id="main_entry_form" class="mt">
												<div class="form_field">
													<label class="text-uppercase text-sm">First Name:</label>
													<input type="input" name="first_name" size="35" id="first_name" class="form-control mb" />
													<div class="clear"></div>
												</div>
												<div class="form_field">
													<label class="text-uppercase text-sm">Last Name:</label>
													<input type="input" name="last_name" size="35" id="last_name" class="form-control mb" />
													<div class="clear"></div>
												</div>
												<div class="form_field">
