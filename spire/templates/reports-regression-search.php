					...
					<form method="get" class="form-horizontal">
						...
						<div class="form-group">
							<div class="col-sm-8 col-sm-offset-2">
								<input type="hidden" name="queryRegressionReports" value="true">
								<input type="hidden" name="view" value="regressionReports">
		...
		<div class="panel-body">
			<?php
				if ($searchResults) {
					...
					echo '<p><i>&nbsp; Last <b>'.$dayRange.'</b> days, station = <b>'.$searchTerm.'</b></i></p>';
